...
const plans = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Plano Tático + Playbook por canal",
...
const featureComparison: FeatureCategory[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Playbook de execução gamificado", starter: false, professional: true, enterprise: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Alertas automáticos de performance (11 regras)", starter: false, professional: true, enterprise: true },
  ...
  },
  {
    ...
    features: [
      { name: "Exportação PDF (Dashboard e projetos)", starter: false, professional: true, enterprise: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Backup e restauração de dados", starter: false, professional: true, enterprise: true },
