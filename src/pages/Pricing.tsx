...
const plans = [
  {
    ...
    highlights: [
      ...
      "Públicos-alvo (até 5)",
      "Análise SEO e PageSpeed",
      "Monitoramento SEO inteligente (manual + live)",
      ...
      "Central de ajuda e suporte por chamado",
    ],
    cta: "Começar Grátis",
    popular: false,
  },
  {
    ...
    highlights: [
      ...
      "Operações, campanhas e budget ilimitados",
      "Calendário + timeline Gantt + alertas",
      "Enriquecimento de ICP com IA",
      "Benchmark competitivo com SWOT + IA ilimitados",
      "Plano Tático + Playbook ilimitados",
      "Exportação PDF e CSV ilimitada",
      "Integrações OAuth (Google, Meta, LinkedIn, TikTok)",
      "Monitoramento SEO inteligente com timeline avançada",
      "Suporte prioritário",
    ],
    cta: "Assinar Agora",
    popular: true,
...
const featureComparison: FeatureCategory[] = [
  {
    ...
    features: [
      { name: "Diagnóstico heurístico de URL (6 dimensões)", starter: true, professional: true, enterprise: true },
      ...
      { name: "Dados estruturados (JSON-LD, OG, Microdata)", starter: true, professional: true, enterprise: true },
      ...
      { name: "Análise de performance por IA", starter: "3/mês", professional: "Ilimitado", enterprise: "Ilimitado" },
      { name: "Enriquecimento de insights por IA", starter: "3/mês", professional: "Ilimitado", enterprise: "Ilimitado" },
      { name: "Enriquecimento de benchmark por IA", starter: "3/mês", professional: "Ilimitado", enterprise: "Ilimitado" },
    ],
  },
  {
    category: "Estratégia e Planejamento",
    features: [
      { name: "Benchmark competitivo (SWOT)", starter: "5/mês", professional: "Ilimitados", enterprise: "Ilimitados" },
      { name: "Gap analysis", starter: "3/mês", professional: "Ilimitado", enterprise: "Ilimitado" },
      { name: "Plano Tático por canal", starter: "1/mês", professional: "Ilimitado", enterprise: "Ilimitado" },
      { name: "Playbook de execução gamificado", starter: "1/mês", professional: "Ilimitado", enterprise: "Ilimitado" },
      { name: "Templates táticos por nicho", starter: "3", professional: "Ilimitados", enterprise: "Ilimitados" },
      { name: "Alertas estratégicos consolidados", starter: true, professional: true, enterprise: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Enriquecimento de ICP com IA", starter: "3/mês", professional: "Ilimitado", enterprise: "Ilimitado" },
      { name: "URLs de concorrentes por projeto", starter: "3", professional: "Ilimitados", enterprise: "Ilimitados" },
    ],
  },
  {
    category: "Operações e Campanhas",
    features: [
      { name: "Gestão de campanhas por canal", starter: "2/mês", professional: "Ilimitado", enterprise: "Ilimitado" },
      { name: "Métricas de performance (35+ KPIs)", starter: true, professional: true, enterprise: true },
      { name: "Análise de performance por IA", starter: "3/mês", professional: "Ilimitado", enterprise: "Ilimitado" },
      { name: "Gestão de budget com pacing", starter: true, professional: true, enterprise: true },
      { name: "Calendário de campanhas", starter: true, professional: true, enterprise: true },
      { name: "Timeline Gantt", starter: true, professional: true, enterprise: true },
      { name: "Alertas automáticos de performance (11 regras)", starter: true, professional: true, enterprise: true },
      { name: "Comparativo tático vs real", starter: true, professional: true, enterprise: true },
    ],
  },
  {
    category: "SEO & Performance",
    features: [
      { name: "Análise SEO e PageSpeed Insights", starter: true, professional: true, enterprise: true },
      { name: "Core Web Vitals", starter: true, professional: true, enterprise: true },
      { name: "Análise SEO/GEO técnica", starter: true, professional: true, enterprise: true },
      { name: "Monitoramento de performance", starter: true, professional: true, enterprise: true },
      { name: "Monitoramento SEO live por projeto", starter: "Limitado", professional: "Ilimitado", enterprise: "Ilimitado" },
      { name: "Timeline inteligente de mudanças", starter: true, professional: true, enterprise: true },
    ],
  },
  {
    ...
    features: [
      ...
      { name: "Sincronização automática de métricas", starter: false, professional: true, enterprise: true },
    ],
  },
  {
    category: "Exportação e Relatórios",
    features: [
      { name: "Exportação PDF (Dashboard e projetos)", starter: "3/mês", professional: "Ilimitado", enterprise: "Ilimitado" },
      { name: "Exportação CSV", starter: "3/mês", professional: "Ilimitado", enterprise: "Ilimitado" },
  ...
  },
  {
    ...
    features: [
      { name: "Onboarding gamificado", starter: true, professional: true, enterprise: true },
      { name: "Central de ajuda com tutoriais", starter: true, professional: true, enterprise: true },
      { name: "Dark / Light mode", starter: true, professional: true, enterprise: true },
      { name: "Notificações em tempo real", starter: true, professional: true, enterprise: true },
      { name: "Sistema de suporte por chamados", starter: true, professional: true, enterprise: true },
      { name: "Backup e restauração de dados", starter: "4/mês", professional: "Ilimitado", enterprise: "Ilimitado" },
      { name: "Múltiplos usuários por conta", starter: false, professional: false, enterprise: true },
      { name: "Onboarding e treinamento dedicado", starter: false, professional: false, enterprise: true },
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                a: "Módulo para estruturar campanhas canal por canal — tipo de campanha, etapa do funil, lances, copy frameworks, segmentação e testes A/B. No Starter você pode criar 1 plano tático por mês. No Professional, ilimitado.",
              },
              {
                q: "O que inclui a Gestão de Campanhas?",
                a: "Criação e monitoramento de campanhas por canal (Google, Meta, LinkedIn, TikTok) com 35+ métricas de performance, budget pacing em tempo real, calendário mensal, timeline Gantt, alertas automáticos de performance e análise por IA. No Starter você pode criar 2 campanhas por mês. No Professional, ilimitado.",
              },
              {
