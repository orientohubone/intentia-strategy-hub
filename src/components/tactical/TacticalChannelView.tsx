        ...
        <div className="rounded-xl border border-border bg-card p-5 space-y-3">
          {plan.ad_group_structure.map((group, i) => (
            <div key={i} className="flex items-start gap-3">
              ...
              <Button variant="ghost" size="icon" className="h-8 w-8 shrink-0" aria-label="Remover grupo de anúncios" onClick={() => removeAdGroup(i)}>
            ...
            return (
              <div key={i} className="border border-border rounded-lg p-4 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="ghost" size="icon" className="h-8 w-8" aria-label="Remover framework de copy" onClick={() => removeCopyFramework(i)}>
                    <Trash2 className="h-3.5 w-3.5 text-muted-foreground" />
                  </Button>
                </div>
                <div className="space-y-2">
          ...
          {segmentations.map((seg, i) => (
            <div key={i} className="border border-border rounded-lg p-4 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <Button variant="ghost" size="icon" className="h-8 w-8" aria-label="Remover segmentação" onClick={() => removeSegmentation(i)}>
                  <Trash2 className="h-3.5 w-3.5 text-muted-foreground" />
                </Button>
              </div>
        ...
        <div className="rounded-xl border border-border bg-card p-5 space-y-3">
          {plan.key_metrics.map((metric, i) => (
            <div key={i} className="flex items-center gap-3">
              ...
              <Button variant="ghost" size="icon" className="h-8 w-8 shrink-0" aria-label="Remover métrica" onClick={() => removeMetric(i)}>
                <Trash2 className="h-3.5 w-3.5 text-muted-foreground" />
              </Button>
            </div>
          ))}
            ...
            <div key={i} className="border border-border rounded-lg p-4 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button variant="ghost" size="icon" className="h-7 w-7" aria-label="Remover plano de teste" onClick={() => removeTestPlan(i)}>
