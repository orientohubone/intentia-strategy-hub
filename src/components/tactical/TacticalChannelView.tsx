        ...
        <div className="rounded-xl border border-border bg-card p-5 space-y-3">
          {plan.ad_group_structure.map((group, i) => (
            <div key={i} className="flex items-start gap-3">
              ...
              <Button variant="ghost" size="icon" className="h-8 w-8 shrink-0" onClick={() => removeAdGroup(i)} aria-label="Remover grupo de anúncios" title="Remover grupo de anúncios">
            ...
            return (
              <div key={i} className="border border-border rounded-lg p-4 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => removeCopyFramework(i)} aria-label="Remover framework de copy" title="Remover framework de copy">
                    <Trash2 className="h-3.5 w-3.5 text-muted-foreground" />
                  </Button>
                </div>
                <div className="space-y-2">
          ...
          {segmentations.map((seg, i) => (
            <div key={i} className="border border-border rounded-lg p-4 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => removeSegmentation(i)} aria-label="Remover segmentação" title="Remover segmentação">
                  <Trash2 className="h-3.5 w-3.5 text-muted-foreground" />
                </Button>
              </div>
        ...
        <div className="rounded-xl border border-border bg-card p-5 space-y-3">
          {plan.key_metrics.map((metric, i) => (
            <div key={i} className="flex items-center gap-3">
              ...
              <Button variant="ghost" size="icon" className="h-8 w-8 shrink-0" onClick={() => removeMetric(i)} aria-label="Remover métrica" title="Remover métrica">
                <Trash2 className="h-3.5 w-3.5 text-muted-foreground" />
              </Button>
            </div>
          ))}
            ...
            <div key={i} className="border border-border rounded-lg p-4 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button variant="ghost" size="icon" className="h-7 w-7" onClick={() => removeTestPlan(i)} aria-label="Remover plano de teste" title="Remover plano de teste">
